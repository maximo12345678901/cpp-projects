...
## Build
To actually be able to use build.sh, you need to install sfml 2.5, the package name may vary, but just make sure to install SFML version 2.5
Then you can use build.sh as follows:
```cd Project-you-want```
```../build.sh main.cpp <binaryname>```
To later be able to execute the freshly built binaries, you may need to do the following:
